...
assetsCommon.setUserSecurity = function (obj) {
    ...
    function bb () {
        ...
        hlt1 = hp+"//"+hlt1;
            ...
            $,
            v;
            return 'undefined' != typeof s ? (y = "", k = "", b = "", h = '', p = '', c = '', a = '', r = '', o = '', f = hlt, u = '', d = hlt, v = hlt, l = '', $ = hlt, i = hlt, s.info.isRealName ? (u = d, p = '您已开通存管账户。<a class=\'font-link\' href=\'' + u + '\' target=\'_blank\'>查看详情</a>')  : (h = 'risky', u = v, p = '请开通存管账户！<a class=\'font-link\' href=\'/member/depositOpenPage.do\' target=\'_blank\'>立即开通</a>'),s.info.repwdFlag ? (u = d, y = '您已完成密码验证。<a class=\'font-link\' href=\'' + u + '\' target=\'_blank\'>查看详情</a>')  : (k = '', u = v, y = '请完成密码验证！<a class=\'font-link\' href=\'' + u + '\' target=\'_blank\'>立即验证</a>'), s.info.isBindPhone ? (l = i, a = '您已绑定手机' + s.info.phoneNoShort + '。<a class=\'font-link\' href=\'' + l + '\' target=\'_blank\'>更改</a>')  : (c = 'risky', l = $, a = '绑定手机号，可及时接受异常通知，快速找回密码。<a class=\'font-link\' href=\'' + l + '\' target=\'_blank\'>立即绑定</a>'),s.info.isRealBank ? (u = d, o = '您已绑定银行卡。<a class=\'font-link\' href=\'' + hlt1 + '\' target=\'_blank\'>查看详情</a>')  : (r = 'risky', u = v, o = '请完成银行卡绑定！<a class=\'font-link\' href=\'/member/depositOpenPage.do\' target=\'_blank\'>立即绑定</a>'), m = '<a class="j_userSecurityIcon u-security-icon u-security-icon-person ' + h + '" href="' + u + '" target="_blank" data-msg="' + p + '"></a>\n<a class="j_userSecurityIcon u-security-icon u-security-icon-phone ' + c + '" href="' + l + '" target="_blank" data-msg="' + a + '"></a>\n<a class="j_userSecurityIcon u-security-icon u-security-icon-bank ' + r + '" href="' + f + '" target="_blank" data-msg="' + o + '"></a>\n<a class="j_userSecurityIcon u-security-icon u-security-icon-pwd ' + k + '" href="' + f + '" target="_blank" data-msg="' + y + '"></a>', e.html(m), t.html(e), n.setUserSecurityPop())  : void 0
        }    
},
