...
$(document).ready(function(){
	...
	if(moreDivVal=="sq"){
		...
		// 取消隐藏筛选条件 by guoxiangyu 20170714 start
		// $("#hkfsDiv").removeClass("hidden");
		// $("#zbztDiv").removeClass("hidden"); 
		// 取消隐藏筛选条件 by guoxiangyu 20170714 end
	}else{
	...
	//$('#investHorize ul li:nth-child(3)').addClass("intro");
});

$('#investHorize ul li').click(function(){
	var type = $('#typelist').val();//投标类型
	//if(',undefined,'==type){type=',-1,';}
	var time = $('#timelist').val();//投标期限
