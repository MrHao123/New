function Calculator(mode){
    if(mode ==='jy' || mode === '129' || mode === '159' || mode === '189'){
        this.mode = mode;
    } else {
        this.mode = 'normal';
    }
...
Calculator.prototype.JY_159 = '159'; //129
Calculator.prototype.JY_189 = '189'; //189
Calculator.prototype.INTEREST_RATE_DICT = {12: 0.1, 18: 0.105, 24: 0.11, 36: 0.12, 48: 0.125}; //费率

//-------线上费率-------
Calculator.prototype.M_FEE_RATE_129_DICT = {12:0.0016, 18:0.0027, 24:0.0030, 36:0.0030, 48:0.0031}; //129平台费率
Calculator.prototype.M_FEE_RATE_159_DICT = {12:0.0044, 18:0.0055, 24:0.0058, 36:0.0057, 48:0.0057}; //159平台费率
Calculator.prototype.M_FEE_RATE_189_DICT = {12:0.0051, 18:0.0067, 24:0.0073, 36:0.0079, 48:0.0084}; //189平台费率

Calculator.prototype.PRE_FEE_RATE_78_DICT = {12:0.0353, 18:0.0484, 24:0.0578, 36:0.0664, 48:0.0718}; //78前期服务费率
Calculator.prototype.PRE_FEE_RATE_129_DICT = {12:0.07, 18:0.08, 24:0.09, 36:0.11, 48:0.12};//129前期服务费率
Calculator.prototype.PRE_FEE_RATE_159_DICT = {12:0.07, 18:0.08, 24:0.09, 36:0.11, 48:0.12};//159前期服务费率
Calculator.prototype.PRE_FEE_RATE_189_DICT = {12:0.09, 18:0.10, 24:0.11, 36:0.12, 48:0.12}; //189前期服务费率
...
Calculator.prototype.ADVANCE_REPAYMENT_RATE_159_DICT = {12:0.04, 18:0.05, 24:0.06, 36:0.08, 48:0.09}; //159保底费率
        ...
        case this.JY_159:
        	if(flag == 'online'){
        		...
        		plan.advanceRepayRate = Calculator.prototype.ADVANCE_REPAYMENT_RATE_159_DICT[plan.period];
	       		...
	       		plan.platformRate = Calculator.prototype.M_FEE_RATE_159_LINE_DICT[plan.period];//平台费率
	       		plan.advanceRepayRate = Calculator.prototype.ADVANCE_REPAYMENT_RATE_159_LINE_DICT[plan.period];
	       	}
        	plan.mfare = round(plan.platformRate * plan.contractAmount);
        	plan.month_pay_total = round(plan.month_pay + plan.mfare);
            plan.loan = plan.principal;
...
Calculator.prototype._getPreFeeRate = function (period,flag) {
    ...
    case this.JY_159:
    	if(flag == 'online'){
    		...
    		preFeeRate = Calculator.prototype.PRE_FEE_RATE_159_LINE_DICT[period];
    	}
        break;
    case this.JY_189:
    	if(flag == 'online'){
