...
/*http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAyNjk2MV8xOTU2MjhfNDAwNjA5OTQwMF8yXw*/
$(function(){
    var protocol = document.location.protocol.toLowerCase();
    var onlineService = $("#onlineService");
    if(protocol == "https:"){
        onlineService.attr("href","http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODE5NjgwOV80MDkyOTFfNDAwMDYwOTE5MV8yXw");
