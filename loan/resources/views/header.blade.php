...
<link href="{{asset('home/personl/css/common.css')}}" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="{{asset('home/personl/css/user.css')}}" />
<script type="text/javascript" src="{{asset('home/personl/script/jquery.min.js')}}"></script>
<!-- <script type="text/javascript" src="{{asset('home/personl/script/common.js')}}"></script> -->
<script src="{{asset('home/personl/script/user.js')}}" type="text/javascript"></script>
...
<script type="text/javascript" src="{{asset('home/js/18daiding.js')}}"></script>
</head>
<body>
<header>
  <div class="header-top min-width">
    <div class="container fn-clear"> <strong class="fn-left">咨询热线：400-668-6698<span class="s-time">服务时间：9:00 - 18:00</span></strong>
      <ul class="header_contact">
        <li class="c_1"> <a class="ico_head_weixin" id="wx"></a>
          <div class="ceng" id="weixin_xlgz" style="display: none;">
            <div class="cnr"> <img src="{{asset('home/personl/images/code.png')}}"> </div>
      ...
      <ul class="fn-right header-top-ul">
        ...
        <li>
          <div class="">
          <a href="login" class="js-login" title="登录">
          登录
          </a>
          </div>
        </li>
  ...
  <div class="header min-width">
    <div class="container">
      <div class="fn-left logo"> <a class="" href="index.html"><img src="{{asset('home/personl/images/logo.png')}}"  title=""> </a> </div>
      <ul class="top-nav fn-clear">
        <li class="on"> <a href="index">首页</a> </li>
        <li> <a href="无" class="">我要投资</a> </li>
        <li> <a href="loan" class="">我要借款</a> </li>
        <li> <a href="帮助中心.html">安全保障</a> </li>
        <li class="top-nav-safe"> <a href="perIndex">我的账户</a> </li>
